...
{
    printf("The Matrix vector simple 4x4 \n");
...
{
    printf("The JACOBI cross test1 funtion \n");
    ...
    {
        x.resize(n);
        printf("Calling the SERIAL JACOBI\n");
